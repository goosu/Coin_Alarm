...
public class CoinResponseDto {
  ...
  private String exchangeId;           //20251030 거래소 ID (예: "UPBIT", "BINANCE_SPOT") ADD
  ...
  private MarketCapTier marketCapTier; //20251030 시가총액 등급 (MEGA/LARGE/MEDIUM) ADD
  ...
  private Double accTradePrice24h; // 24시간 누적 거래대금 //20251030 추후 확인후 수정필요성 

  // Upbit Ticker API의 signed_change_rate를 백엔드에서 100 곱해 %로 변환한 값
  //20251030 1분,5분 추가
  private Double change1m;             // 1분 가격 변화율 (%)
  private Double change5m;             // 5분 가격 변화율 (%)
  private Double change24h;            // 24시간 가격 변화율 (%)
